...
#define GSM340_UDL_OCT_MAX 182  /*!< Maximum TP-UD length (in octets) for 7-bit encoding */
#define GSM340_UDL_SPT_MAX 208  /*!< Maximum TP-UD length (in seplets) for 8-bit and UCS-2 encoding */
